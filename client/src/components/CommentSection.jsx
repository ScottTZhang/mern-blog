...
export default function CommentSection({ postId }) {
  ...
  const [showModal, setShowModal] = useState(false); //popup to ask user to confirm delete
  const [commentToDelete, setCommentToDelete] = useState(null); //store the comment to delete
